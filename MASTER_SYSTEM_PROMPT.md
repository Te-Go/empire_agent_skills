...
1. READ: `@.agent-skills/01-architecture/TEDDER_STACK_LAWS.md`
...
4. READ: `@.agent-skills/02-component-logic/frontend-ui-engineering.md`
5. READ: `@.agent-skills/02-component-logic/api-and-interface-design.md`
6. READ: `@.agent-skills/02-component-logic/incremental-implementation.md`

### AUTHORITY LEVEL 3: PREMIUM AESTHETICS & TURKIYE UX
7. READ: `@.agent-skills/03-aesthetics/ui-styling-SKILL.md`
8. READ: `@.agent-skills/03-aesthetics/shadcn-theming.md`
9. READ: `@.agent-skills/03-aesthetics/tailwind-customization.md`
10. READ: `@.agent-skills/03-aesthetics/turkiye-ux-elite.md`

### AUTHORITY LEVEL 4: SEARCH DOMINANCE (SEO & AEO)
11. READ: `@.agent-skills/04-seo-geo-mastery/SEO_AEO_LAWS.md`
12. READ: `@.agent-skills/04-seo-geo-mastery/seo-aeo-mesh-master.md`

### AUTHORITY LEVEL 5: MARKET LOCALIZATION
13. READ: `@.agent-skills/05-localization/turkish-market-rules.md`
